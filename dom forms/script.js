...
<div class="form-row">
    <div class="form-group col-md-4">        
        ...
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="inlineUdon">choclates</label>
        </div>
    </div>
    <div class="form-group col-md-4">
        <div class="form-check form-check-inline">
...
<div class="form-group">
  ...
  <input type="text" name="address2" class="form-control" id="inputAddress2" placeholder="Apartment, building or floor">
</div>
